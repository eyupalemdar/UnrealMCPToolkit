...
> 143 MCP tools across 24 TCP command categories plus client-only tools. UE 5.7, TCP port auto-discovery plus multi-editor routing and native localhost HTTP/MCP probe support.
...
now covers all 126 TCP wrappers: read-only payload wrappers, the safe write-scope set
