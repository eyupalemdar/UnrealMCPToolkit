...
> 191 MCP tools across 30 TCP command categories plus client-only tools. UE 5.7, TCP port auto-discovery plus multi-editor routing and native localhost HTTP/MCP probe support.
...
## 18. Widget Preview Capture (IFTP verify loop)
...
## 23. Async Jobs and Safety Metadata
...
## 25. MCP Resources, Prompts, and Metadata
