...
> 188 MCP tools across 29 TCP command categories plus client-only tools. UE 5.7, TCP port auto-discovery plus multi-editor routing and native localhost HTTP/MCP probe support.
...
## 17. Widget Preview Capture (IFTP verify loop)
...
## 22. Async Jobs and Safety Metadata
...
## 24. MCP Resources, Prompts, and Metadata
