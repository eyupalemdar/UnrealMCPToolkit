...
> 193 MCP tools across 34 TCP command categories plus client-only tools. UE 5.7, TCP port auto-discovery plus multi-editor routing and native localhost HTTP/MCP probe support.
...
## 19. Widget Preview Capture (IFTP verify loop)
...
## 24. Async Jobs and Safety Metadata
...
## 26. MCP Resources, Prompts, and Metadata
