...
> 186 MCP tools across 28 TCP command categories plus client-only tools. UE 5.7, TCP port auto-discovery plus multi-editor routing and native localhost HTTP/MCP probe support.
...
## 16. Widget Preview Capture (IFTP verify loop)
...
## 21. Async Jobs and Safety Metadata
...
## 23. MCP Resources, Prompts, and Metadata
