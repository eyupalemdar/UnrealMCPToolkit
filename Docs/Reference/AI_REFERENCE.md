...
> 183 MCP tools across 28 TCP command categories plus client-only tools. UE 5.7, TCP port auto-discovery plus multi-editor routing and native localhost HTTP/MCP probe support.
...
## 15. Widget Preview Capture (IFTP verify loop)
...
## 20. Async Jobs and Safety Metadata
...
## 22. MCP Resources, Prompts, and Metadata
