...
TSharedPtr<FJsonObject> UAIAssetImportBuilder::ImportTexture(
...
TSharedPtr<FJsonObject> UAIAssetImportBuilder::ImportFont(
	const FString& PackagePath,
	...
	FString& OutError)
{
	...
	for (const FAIImportFontFaceSpec& Face : Faces)
	{
