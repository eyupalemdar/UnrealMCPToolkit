...
#include "Builders/AIBlueprintComponentBuilder.h"
...
UBlueprint* UAIBlueprintComponentBuilder::LoadActorBlueprint(const FString& AssetPath, FString& OutError)
{
...
UClass* UAIBlueprintComponentBuilder::ResolveComponentClass(const FString& ComponentClassName, FString& OutError)
{
...
TSharedPtr<FJsonObject> UAIBlueprintComponentBuilder::BuildComponentNodeJson(USCS_Node* Node, USimpleConstructionScript* SCS)
{
...
TSharedPtr<FJsonObject> UAIBlueprintComponentBuilder::ListComponents(const FString& AssetPath, FString& OutError)
{
...
TSharedPtr<FJsonObject> UAIBlueprintComponentBuilder::AddComponent(
...
TSharedPtr<FJsonObject> UAIBlueprintComponentBuilder::RemoveComponent(
	const FString& AssetPath,
	const FString& ComponentName,
...
TSharedPtr<FJsonObject> UAIBlueprintComponentBuilder::SetComponentProperty(
	const FString& AssetPath,
	const FString& ComponentName,
...
void UAIBlueprintComponentBuilder::FinishBlueprintMutation(
