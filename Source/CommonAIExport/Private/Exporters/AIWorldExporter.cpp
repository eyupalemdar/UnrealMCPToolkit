...
bool UAIWorldExporter::CanExport(UObject* Asset) const
{
	return Asset && Asset->IsA<UWorld>();
}

TArray<UClass*> UAIWorldExporter::GetSupportedClasses() const
{
	return { UWorld::StaticClass() };
}

FString UAIWorldExporter::Export(UObject* Asset, bool bFilterDefaults)
{
...
FString UAIWorldExporter::ExportWorldMetadata(UWorld* World)
{
	FString Output;
...
FString UAIWorldExporter::ExportWorldSettings(UWorld* World, bool bFilterDefaults)
{
...
FString UAIWorldExporter::ExportStreamingLevels(UWorld* World)
{
...
FString UAIWorldExporter::ExportActors(UWorld* World, bool bFilterDefaults)
{
	FString Output;
...
FString UAIWorldExporter::ExportActor(AActor* Actor, int32 IndentLevel, bool bFilterDefaults)
{
	if (!Actor)
	{
		return TEXT("");
...
bool UAIWorldExporter::ShouldSkipActor(AActor* Actor) const
{
	if (!Actor)
	{
		return true;
...
FString UAIWorldExporter::GetActorClassName(AActor* Actor) const
{
	if (!Actor)
	{
		return TEXT("Unknown");
