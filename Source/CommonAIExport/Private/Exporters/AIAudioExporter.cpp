...
bool UAIAudioExporter::CanExport(UObject* Asset) const
{
	if (!Asset)
	{
		return false;
...
TArray<UClass*> UAIAudioExporter::GetSupportedClasses() const
{
	return {
...
FString UAIAudioExporter::Export(UObject* Asset, bool bFilterDefaults)
{
	// Audio Foundation
...
FString UAIAudioExporter::ExportSoundClass(USoundClass* SoundClass, bool bFilterDefaults)
{
	FString Output;
...
FString UAIAudioExporter::ExportSoundSubmix(USoundSubmix* Submix, bool bFilterDefaults)
{
	FString Output;
...
FString UAIAudioExporter::ExportSoundConcurrency(USoundConcurrency* Concurrency, bool bFilterDefaults)
{
	FString Output;
...
FString UAIAudioExporter::ExportSoundAttenuation(USoundAttenuation* Attenuation, bool bFilterDefaults)
{
	FString Output;
...
FString UAIAudioExporter::ExportSoundControlBus(USoundControlBus* Bus, bool bFilterDefaults)
{
	FString Output;
...
FString UAIAudioExporter::ExportSoundControlBusMix(USoundControlBusMix* Mix, bool bFilterDefaults)
{
	FString Output;
...
FString UAIAudioExporter::ExportSoundModulationPatch(USoundModulationPatch* Patch, bool bFilterDefaults)
{
	FString Output;
