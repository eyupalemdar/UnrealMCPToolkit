...
bool UAIDataAssetExporter::CanExport(UObject* Asset) const
{
	return Asset && Asset->IsA<UDataAsset>();
}

TArray<UClass*> UAIDataAssetExporter::GetSupportedClasses() const
{
	return { UDataAsset::StaticClass() };
}

FString UAIDataAssetExporter::Export(UObject* Asset, bool bFilterDefaults)
{
...
FString UAIDataAssetExporter::ExportDataAsset(UDataAsset* DataAsset, bool bFilterDefaults)
{
	FString Output;
