...
bool UAIInputExporter::CanExport(UObject* Asset) const
{
	if (!Asset)
	{
		return false;
...
TArray<UClass*> UAIInputExporter::GetSupportedClasses() const
{
	return {
...
FString UAIInputExporter::Export(UObject* Asset, bool bFilterDefaults)
{
...
FString UAIInputExporter::ExportInputAction(UInputAction* InputAction, bool bFilterDefaults)
{
	FString Output;
...
FString UAIInputExporter::ExportInputMappingContext(UInputMappingContext* MappingContext, bool bFilterDefaults)
{
	FString Output;
