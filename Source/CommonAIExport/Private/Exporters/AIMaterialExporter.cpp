...
bool UAIMaterialExporter::CanExport(UObject* Asset) const
{
	if (!Asset)
	{
		return false;
...
TArray<UClass*> UAIMaterialExporter::GetSupportedClasses() const
{
	return {
...
FString UAIMaterialExporter::Export(UObject* Asset, bool bFilterDefaults)
{
...
FString UAIMaterialExporter::ExportMaterial(UMaterial* Material, bool bFilterDefaults)
{
	FString Output;
...
FString UAIMaterialExporter::ExportMaterialMetadata(UMaterial* Material)
{
	FString Output;
...
FString UAIMaterialExporter::ExportMaterialSettings(UMaterial* Material)
{
	FString Output;
...
FString UAIMaterialExporter::ExportMaterialParameters(UMaterialInterface* Material, bool bIncludeDefaults)
{
	FString Output;
...
FString UAIMaterialExporter::ExportRootConnections(UMaterial* Material)
{
	FString Output;
...
FString UAIMaterialExporter::ExportMaterialGraph(UMaterial* Material)
{
	FString Output;
...
FString UAIMaterialExporter::ExportMaterialExpression(UMaterialExpression* Expression)
{
	FString Output;
...
FString UAIMaterialExporter::GetExpressionTypeName(UMaterialExpression* Expression) const
{
...
FString UAIMaterialExporter::GetExpressionDisplayName(UMaterialExpression* Expression) const
{
...
FString UAIMaterialExporter::ExportExpressionInputs(UMaterialExpression* Expression)
{
	FString Output;
...
FString UAIMaterialExporter::ExportExpressionOutputs(UMaterialExpression* Expression)
{
	FString Output;
...
FString UAIMaterialExporter::ExportExpressionProperties(UMaterialExpression* Expression)
{
	FString Output;
...
FString UAIMaterialExporter::GetMaterialPropertyName(int32 PropertyIndex) const
{
...
FString UAIMaterialExporter::ExportMaterialInstance(UMaterialInstance* MaterialInstance, bool bFilterDefaults)
{
	FString Output;
