...
FString UAIExporterBase::ExportObjectProperties(UObject* Object, int32 IndentLevel, bool bFilterDefaults)
{
	if (!Object)
	{
		return TEXT("(null)\n");
...
FString UAIExporterBase::ExportCDOProperties(UClass* Class, bool bFilterDefaults)
{
	if (!Class)
	{
...
bool UAIExporterBase::ShouldSkipProperty(FProperty* Property, UObject* Object, bool bFilterDefaults) const
{
	if (!Property)
	{
		return true;
...
FString UAIExporterBase::FormatPropertyValue(FProperty* Property, const void* ValuePtr, UObject* Object) const
{
	FString ValueStr;
...
bool UAIExporterBase::IsInstancedObjectProperty(FProperty* Property) const
{
	return Property && Property->ContainsInstancedObjectProperty();
}

FString UAIExporterBase::ExportObjectPropertiesDeep(UObject* Object, const FString& PathPrefix, int32 Depth, bool bFilterDefaults)
{
...
void UAIExporterBase::ExportPropertyWithPath(FProperty* Property, const void* ValuePtr, UObject* Object, const FString& CurrentPath, int32 Depth, bool bFilterDefaults, FString& OutResult)
{
...
FString UAIExporterBase::ExportGraphToText(UEdGraph* Graph)
{
	if (!Graph)
	{
...
FString UAIExporterBase::ExportGraphToTextSimplified(UEdGraph* Graph)
{
	if (!Graph)
	{
		return TEXT("(null graph)\n");
...
FString UAIExporterBase::ExportNodeSimplified(UEdGraphNode* Node)
{
	if (!Node)
	{
		return TEXT("");
...
FString UAIExporterBase::ExportPinSimplified(UEdGraphPin* Pin)
{
	if (!Pin || Pin->bHidden)
	{
		return TEXT("");
...
FString UAIExporterBase::GetPinTypeString(const FEdGraphPinType& PinType)
{
	FString TypeStr;
...
FString UAIExporterBase::GetIndent(int32 Level) const
{
	return FString::ChrN(Level * 2, TEXT(' '));
}

FString UAIExporterBase::MakeSectionHeader(const FString& Title) const
{
	return FString::Printf(TEXT("=== %s ===\n"), *Title);
}

FString UAIExporterBase::MakeSubsectionHeader(const FString& Title) const
{
	return FString::Printf(TEXT("--- %s ---\n"), *Title);
}

FString UAIExporterBase::SanitizeString(const FString& Input) const
{
