...
bool UAIAnimBlueprintExporter::CanExport(UObject* Asset) const
{
	return Asset && Asset->IsA<UAnimBlueprint>();
}

TArray<UClass*> UAIAnimBlueprintExporter::GetSupportedClasses() const
{
	return { UAnimBlueprint::StaticClass() };
}

FString UAIAnimBlueprintExporter::Export(UObject* Asset, bool bFilterDefaults)
{
...
FString UAIAnimBlueprintExporter::ExportAnimBlueprint(UAnimBlueprint* AnimBP, bool bFilterDefaults)
{
	FString Output;
...
FString UAIAnimBlueprintExporter::ExportAnimGraphSummary(UAnimBlueprint* AnimBP)
{
	if (!AnimBP)
	{
		return TEXT("");
...
FString UAIAnimBlueprintExporter::ExportAnimNotifies(UAnimBlueprint* AnimBP)
{
	if (!AnimBP)
	{
		return TEXT("");
...
FString UAIAnimBlueprintExporter::ExportLinkedAnimLayers(UAnimBlueprint* AnimBP)
{
	if (!AnimBP)
	{
		return TEXT("");
...
FString UAIAnimBlueprintExporter::ExportSlotNames(UAnimBlueprint* AnimBP)
{
	if (!AnimBP)
	{
		return TEXT("");
