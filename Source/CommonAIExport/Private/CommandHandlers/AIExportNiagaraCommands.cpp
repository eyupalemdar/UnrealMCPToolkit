...
namespace CommonAIExport::CommandHandlers::Niagara
{
namespace
{
...
TSharedPtr<FJsonObject> BuildEmitterHandleJson(const FNiagaraEmitterHandle& Handle, const FNiagaraInfoOptions& Options)
{
	...
	{
		Data->SetObjectField(TEXT("instance"), CommonAIExport::RuntimeDiagnostics::BuildObjectReferenceJson(InstanceEmitter));
