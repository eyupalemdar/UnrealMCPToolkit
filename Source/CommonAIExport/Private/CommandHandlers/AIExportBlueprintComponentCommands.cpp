...
FString HandleBlueprintComponentList(TSharedPtr<FJsonObject> Params)
{
	...
	{
		FString Error;
		TSharedPtr<FJsonObject> Data = UAIBlueprintComponentBuilder::ListComponents(AssetPath, Error);
		if (!Data.IsValid())
		{
...
FString HandleBlueprintComponentAdd(TSharedPtr<FJsonObject> Params)
{
	...
	{
		FString Error;
		TSharedPtr<FJsonObject> Data = UAIBlueprintComponentBuilder::AddComponent(
			AssetPath,
			ComponentName,
			ComponentClassName,
			ParentComponentName,
...
FString HandleBlueprintComponentRemove(TSharedPtr<FJsonObject> Params)
{
	...
	{
		FString Error;
		TSharedPtr<FJsonObject> Data = UAIBlueprintComponentBuilder::RemoveComponent(
			AssetPath,
			ComponentName,
			bPromoteChildren,
			bCompileBlueprint,
...
FString HandleBlueprintComponentSetProperty(TSharedPtr<FJsonObject> Params)
{
	...
	{
		FString Error;
		TSharedPtr<FJsonObject> Data = UAIBlueprintComponentBuilder::SetComponentProperty(
			AssetPath,
			ComponentName,
			PropertyPath,
			Value,
