...
{
using CommonAIExport::CommandHandlers::CreateErrorResponse;
using CommonAIExport::CommandHandlers::CreateSuccessResponse;

FAIExportCommandContext BuildCommandContext(TSharedPtr<FJsonObject> RootObject, const FAIExportCommandDescriptor& Descriptor)
{
	FAIExportCommandContext Context;
...
FString ProcessCommandEnvelope(const FString& JsonCommand, const FAIExportCommandProcessorCallbacks& Callbacks)
{
	...
	FAIExportCommandDescriptor Descriptor;
	...
	const FAIExportCommandContext Context = BuildCommandContext(RootObject, Descriptor);
	FString ScopeError;
	...
	const TFunction<bool(const FString& CommandName, FAIExportCommandDescriptor& OutDescriptor)>& ResolveCommand)
{
	...
	const FAIExportCommandContext Context = BuildCommandContext(SyntheticRoot, Descriptor);
	FString ScopeError;
	if (!ValidateCommandScope(Descriptor, Context, ScopeError))
	{
		return ScopeError;
