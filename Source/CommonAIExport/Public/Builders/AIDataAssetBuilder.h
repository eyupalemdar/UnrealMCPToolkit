...
#include "AIDataAssetBuilder.generated.h"
 ...
 * resolution for array/property operations. Works alongside AIWidgetBlueprintBuilder
 ...
 */
UCLASS()
class COMMONAIEXPORT_API UAIDataAssetBuilder : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 * Delegates to UAIWidgetBlueprintBuilder::AddArrayElement after path resolution.
	 */
