...
#include "AIAssetFactory.generated.h"
 ...
 *
 * For type-specific editing after creation, use UAIDataAssetBuilder::SetProperty().
 * All functions are static. Call from Game Thread only.
 */
UCLASS()
class COMMONAIEXPORT_API UAIAssetFactory : public UObject
{
	GENERATED_BODY()
