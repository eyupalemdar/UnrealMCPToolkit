...
#include "AIAnimBlueprintBuilder.generated.h"
 ...
 *
 * EventGraph manipulation is handled by the existing AIBlueprintGraphBuilder.
 ...
 */
UCLASS()
class COMMONAIEXPORT_API UAIAnimBlueprintBuilder : public UObject
{
	GENERATED_BODY()
