...
#include "MCTExporterBase.generated.h"
 ...
 * 1. Create a new class inheriting from UMCTExporterBase
 * 2. Implement CanExport(), GetSupportedClasses(), and Export()
 * 3. Register it with UMCTExporterRegistry
 */
UCLASS(Abstract)
class MCPTOOLKIT_API UMCTExporterBase : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	virtual bool CanExport(UObject* Asset) const PURE_VIRTUAL(UMCTExporterBase::CanExport, return false;);

	/**
	 * Get the list of UClass types this exporter supports.
	 * Used for type registration and discovery.
	 */
	virtual TArray<UClass*> GetSupportedClasses() const PURE_VIRTUAL(UMCTExporterBase::GetSupportedClasses, return {};);
	 ...
	 */
	virtual FString Export(UObject* Asset, bool bFilterDefaults = false) PURE_VIRTUAL(UMCTExporterBase::Export, return TEXT(""););
