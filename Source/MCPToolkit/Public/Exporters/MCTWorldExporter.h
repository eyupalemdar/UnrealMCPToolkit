...
#include "MCTWorldExporter.generated.h"
 ...
 *
 * This is a NEW capability for MCPToolkit - Map export support.
 *
 * Exports:
 ...
 */
UCLASS()
class MCPTOOLKIT_API UMCTWorldExporter : public UMCTExporterBase
{
	GENERATED_BODY()
