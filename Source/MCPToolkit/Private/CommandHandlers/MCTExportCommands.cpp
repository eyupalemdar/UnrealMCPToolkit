...
namespace MCPToolkit::CommandHandlers::Export
{
FString HandleExportWidget(TSharedPtr<FJsonObject> Params)
{
	...
	FMCTExportResult Result = Future.Get();
...
FString HandleListSupportedTypes()
{
	...
	TArray<UClass*> SupportedClasses = UMCTExporterRegistry::Get()->GetAllSupportedClasses();
