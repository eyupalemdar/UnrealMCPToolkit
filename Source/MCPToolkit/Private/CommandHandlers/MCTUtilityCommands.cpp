...
namespace
{
void WriteCommandDescriptorJson(const FMCTUtilityCommandDescriptor& Descriptor, TSharedPtr<FJsonObject> OutObject)
{
...
TSharedPtr<FJsonObject> BuildEditorIdentityJson(const FMCTUtilityContext& Context)
{
	...
	Transports->SetStringField(TEXT("native_http_auth_env"), TEXT("MCPTOOLKIT_HTTP_TOKEN"));
	Transports->SetStringField(TEXT("native_http_legacy_auth_envs"), TEXT("COMMONAI_MCP_HTTP_TOKEN,COMMONAIEXPORT_HTTP_TOKEN"));
	...
	Data->SetStringField(TEXT("server"), TEXT("MCPToolkit"));
	...
	Data->SetStringField(TEXT("plugin_name"), TEXT("MCPToolkit"));
...
TSharedPtr<FJsonObject> BuildCommandManifestJson(const FMCTUtilityContext& Context)
{
	...
	for (const FMCTUtilityCommandDescriptor& Descriptor : Context.Commands)
	{
	...
	Manifest->SetStringField(TEXT("server"), TEXT("MCPToolkit"));
...
FString HandleCommandManifestExport(TSharedPtr<FJsonObject> Params, const FMCTUtilityContext& Context)
{
	...
	{
		OutputPath = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("AIManifests"), TEXT("MCPToolkit_CommandManifest.json"));
	}
