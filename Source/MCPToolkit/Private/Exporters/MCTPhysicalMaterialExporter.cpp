...
bool UMCTPhysicalMaterialExporter::CanExport(UObject* Asset) const
{
	return Asset && Asset->IsA<UPhysicalMaterial>();
}

TArray<UClass*> UMCTPhysicalMaterialExporter::GetSupportedClasses() const
{
	return { UPhysicalMaterial::StaticClass() };
}

FString UMCTPhysicalMaterialExporter::Export(UObject* Asset, bool bFilterDefaults)
{
...
FString UMCTPhysicalMaterialExporter::ExportPhysicalMaterial(UPhysicalMaterial* PhysMat, bool bFilterDefaults)
{
	FString Output;
