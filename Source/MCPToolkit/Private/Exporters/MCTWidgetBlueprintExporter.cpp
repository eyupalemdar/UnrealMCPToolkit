...
bool UMCTWidgetBlueprintExporter::CanExport(UObject* Asset) const
{
	return Asset && Asset->IsA<UWidgetBlueprint>();
}

TArray<UClass*> UMCTWidgetBlueprintExporter::GetSupportedClasses() const
{
	return { UWidgetBlueprint::StaticClass() };
}

FString UMCTWidgetBlueprintExporter::Export(UObject* Asset, bool bFilterDefaults)
{
...
FString UMCTWidgetBlueprintExporter::ExportWidgetTree(UWidget* Widget, int32 IndentLevel, bool bFilterDefaults)
{
	if (!Widget)
	{
		return TEXT("");
...
FString UMCTWidgetBlueprintExporter::ExportWidgetProperties(UWidget* Widget, int32 IndentLevel, bool bFilterDefaults)
{
	if (!Widget)
	{
		return TEXT("");
...
FString UMCTWidgetBlueprintExporter::ExportSlotProperties(UWidget* Widget, int32 IndentLevel)
{
	if (!Widget)
	{
		return TEXT("");
...
FString UMCTWidgetBlueprintExporter::GetWidgetTypeName(UWidget* Widget) const
{
	if (!Widget)
	{
		return TEXT("Unknown");
...
FString UMCTWidgetBlueprintExporter::ExportWidgetPropertiesViaReflection(UWidget* Widget, int32 IndentLevel, bool bFilterDefaults)
{
	if (!Widget)
	{
		return TEXT("");
...
FString UMCTWidgetBlueprintExporter::ExportSlotPropertiesViaReflection(UPanelSlot* Slot, int32 IndentLevel, bool bFilterDefaults)
{
	if (!Slot)
	{
		return TEXT("");
...
FString UMCTWidgetBlueprintExporter::ExportStructDecomposed(FStructProperty* StructProp, const void* StructPtr,
...
bool UMCTWidgetBlueprintExporter::ShouldSkipWidgetProperty(FProperty* Property, const FName& PropertyName) const
{
	if (!Property)
	{
		return true;
...
bool UMCTWidgetBlueprintExporter::ShouldSkipSlotProperty(FProperty* Property, const FName& PropertyName) const
{
	if (!Property)
	{
		return true;
...
FString UMCTWidgetBlueprintExporter::ExportAnimations(UWidgetBlueprint* WidgetBP, bool bFilterDefaults)
{
...
FString UMCTWidgetBlueprintExporter::ExportMovieSceneTracks(UMovieScene* MovieScene, bool bFilterDefaults)
{
	if (!MovieScene)
	{
		return TEXT("");
...
FString UMCTWidgetBlueprintExporter::ExportMovieSceneTracksSimplified(UMovieScene* MovieScene)
{
	if (!MovieScene)
	{
		return TEXT("");
...
FString UMCTWidgetBlueprintExporter::ExportTrackSimplified(UMovieSceneTrack* Track, const FFrameRate& FrameRate)
{
	if (!Track)
	{
		return TEXT("");
...
FString UMCTWidgetBlueprintExporter::ExtractKeyframeValues(UMovieSceneSection* Section, const FFrameRate& FrameRate, float& OutStartTime, float& OutEndTime)
{
	if (!Section)
	{
		return TEXT("");
