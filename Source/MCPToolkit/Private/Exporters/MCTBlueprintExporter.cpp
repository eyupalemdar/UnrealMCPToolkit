...
bool UMCTBlueprintExporter::CanExport(UObject* Asset) const
{
	if (!Asset)
	{
		return false;
...
TArray<UClass*> UMCTBlueprintExporter::GetSupportedClasses() const
{
	return { UBlueprint::StaticClass() };
}

FString UMCTBlueprintExporter::Export(UObject* Asset, bool bFilterDefaults)
{
...
FString UMCTBlueprintExporter::ExportBlueprint(UBlueprint* Blueprint, bool bFilterDefaults)
{
	FString Output;
...
FString UMCTBlueprintExporter::ExportInterfaces(UBlueprint* Blueprint)
{
...
FString UMCTBlueprintExporter::ExportVariables(UBlueprint* Blueprint, bool bFilterDefaults)
{
