...
UEdGraph* UMCTBlueprintGraphBuilder::GetEventGraph(UBlueprint* Blueprint)
{
	if (!Blueprint)
	{
		return nullptr;
...
UEdGraph* UMCTBlueprintGraphBuilder::FindGraph(
...
UEdGraph* UMCTBlueprintGraphBuilder::ResolveGraph(
	UBlueprint* Blueprint,
	const FString& GraphName)
{
...
UK2Node* UMCTBlueprintGraphBuilder::FindNodeByName(
	UBlueprint* Blueprint,
...
UEdGraphPin* UMCTBlueprintGraphBuilder::FindPin(
	UK2Node* Node,
...
FEdGraphPinType UMCTBlueprintGraphBuilder::ResolveVarType(const FString& TypeString)
{
...
UK2Node* UMCTBlueprintGraphBuilder::AddEventNode(
	UBlueprint* Blueprint,
...
UK2Node* UMCTBlueprintGraphBuilder::AddCustomEvent(
	UBlueprint* Blueprint,
	const FString& EventName,
	const FString& NodeName,
	int32 PosX, int32 PosY,
...
UK2Node* UMCTBlueprintGraphBuilder::AddFunctionCallNode(
	UBlueprint* Blueprint,
	const FString& FunctionName,
	const FString& NodeName,
...
UK2Node* UMCTBlueprintGraphBuilder::AddVariableGetNode(
	UBlueprint* Blueprint,
...
UK2Node* UMCTBlueprintGraphBuilder::AddVariableSetNode(
	UBlueprint* Blueprint,
	const FString& VariableName,
	const FString& NodeName,
	int32 PosX, int32 PosY,
...
UK2Node* UMCTBlueprintGraphBuilder::AddMakeStructNode(
	UBlueprint* Blueprint,
...
UK2Node* UMCTBlueprintGraphBuilder::AddBranchNode(
	UBlueprint* Blueprint,
	const FString& NodeName,
	int32 PosX, int32 PosY,
	const FString& GraphName)
...
UK2Node* UMCTBlueprintGraphBuilder::AddCallParentFunctionNode(
	UBlueprint* Blueprint,
	const FString& FunctionName,
	const FString& NodeName,
	int32 PosX, int32 PosY,
...
bool UMCTBlueprintGraphBuilder::ConnectPins(
	UBlueprint* Blueprint,
...
bool UMCTBlueprintGraphBuilder::SetPinDefaultValue(
	UBlueprint* Blueprint,
	const FString& NodeName,
	const FString& PinName,
...
bool UMCTBlueprintGraphBuilder::RemoveNode(
	UBlueprint* Blueprint,
	const FString& NodeName,
	const FString& GraphName)
{
...
UEdGraph* UMCTBlueprintGraphBuilder::EnsureFunctionGraph(
	UBlueprint* Blueprint,
	const FString& FunctionName,
	const TArray<FMCTBlueprintGraphPinSpec>& Inputs,
	const TArray<FMCTBlueprintGraphPinSpec>& Outputs,
	...
	const FString& ResultNodeName)
{
	...
	if (EntryNode)
	{
		...
		for (const FMCTBlueprintGraphPinSpec& PinSpec : Inputs)
		{
	...
	if (Outputs.Num() > 0)
	{
		...
		for (const FMCTBlueprintGraphPinSpec& PinSpec : Outputs)
		{
...
TSharedPtr<FJsonObject> UMCTBlueprintGraphBuilder::GetGraphAsJson(
	UBlueprint* Blueprint,
	const FString& GraphName)
{
...
TArray<FString> UMCTBlueprintGraphBuilder::ListGraphs(UBlueprint* Blueprint)
{
...
bool UMCTBlueprintGraphBuilder::AddVariable(
	UBlueprint* Blueprint,
...
bool UMCTBlueprintGraphBuilder::SetVariableDefault(
	UBlueprint* Blueprint,
	const FString& VarName,
	const FString& DefaultValue)
{
...
bool UMCTBlueprintGraphBuilder::RemoveVariable(
	UBlueprint* Blueprint,
	const FString& VarName)
{
	if (!Blueprint || VarName.IsEmpty())
...
TSharedPtr<FJsonObject> UMCTBlueprintGraphBuilder::GetVariablesAsJson(UBlueprint* Blueprint)
{
	TSharedPtr<FJsonObject> Result = MakeShared<FJsonObject>();
	if (!Blueprint)
	{
