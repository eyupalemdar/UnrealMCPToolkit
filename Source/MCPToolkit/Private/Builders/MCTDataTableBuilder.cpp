...
FString UMCTDataTableBuilder::JsonValueToImportText(const TSharedPtr<FJsonValue>& Value)
{
	if (!Value.IsValid())
	{
		return TEXT("");
...
UDataTable* UMCTDataTableBuilder::LoadDataTable(const FString& AssetPath, FString& OutError)
{
...
TSharedPtr<FJsonObject> UMCTDataTableBuilder::BuildStructRowJson(UScriptStruct* RowStruct, const uint8* RowData)
{
...
TSharedPtr<FJsonObject> UMCTDataTableBuilder::BuildDataTableInfoJson(UDataTable* DataTable)
{
...
TSharedPtr<FJsonObject> UMCTDataTableBuilder::CreateDataTable(
	...
	FString& OutError)
{
	...
	const FScopedTransaction Transaction(NSLOCTEXT("MCPToolkit", "CreateDataTable", "AI Create DataTable"));
...
TSharedPtr<FJsonObject> UMCTDataTableBuilder::ReadRows(
...
TSharedPtr<FJsonObject> UMCTDataTableBuilder::AddRow(
	const FString& AssetPath,
	...
	FString& OutError)
{
	...
	const FScopedTransaction Transaction(NSLOCTEXT("MCPToolkit", "AddDataTableRow", "AI Add DataTable Row"));
...
TSharedPtr<FJsonObject> UMCTDataTableBuilder::RemoveRow(
	const FString& AssetPath,
	const FString& RowName,
	const bool bSave,
	FString& OutError)
{
	...
	const FScopedTransaction Transaction(NSLOCTEXT("MCPToolkit", "RemoveDataTableRow", "AI Remove DataTable Row"));
	DataTable->Modify();
...
TSharedPtr<FJsonObject> UMCTDataTableBuilder::ImportCsv(
	const FString& AssetPath,
	...
	FString& OutError)
{
	...
	const FScopedTransaction Transaction(NSLOCTEXT("MCPToolkit", "ImportDataTableCsv", "AI Import DataTable CSV"));
	DataTable->Modify();
...
bool UMCTDataTableBuilder::SaveDataTable(UDataTable* DataTable)
{
	return DataTable && UMCTDataAssetBuilder::SaveAsset(DataTable);
}
